...
export const metadata: Metadata = {
  title: "Cookie Policy | TheAttReviews",
  description: "Cookie Policy for TheAttReviews - Learn how we use cookies on our website",
};
...
export default function CookiePolicy() {
  return (
    <div className="prose dark:prose-invert max-w-none py-8">
      ...
      <h2>Introduction</h2>
      <p>
        TheAttReviews ("we," "our," or "us") uses cookies on our website. By using the website, you consent to the use of cookies.
      </p>
      <p>
      ...
      <h2>How TheAttReviews Uses Cookies</h2>
      <p>
      ...
      <ul>
        ...
        <li><strong>Preferences cookies.</strong> We may use preferences cookies to remember information that changes the way the website behaves or looks, such as the "remember me" functionality or a user's language preference on the website.</li>
        <li><strong>Analytics cookies.</strong> We may use analytics cookies to track information about how the website is used so that we can make improvements. We may also use analytics cookies to test new advertisements, pages, features, or new functionality of the website to see how our users react to them.</li>
      ...
      <p>
        For more information on the privacy practices of Google, please visit the <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">Google Privacy & Terms web page</a>.
      </p>

      <h2>Google AdSense</h2>
      <p>
        We use Google AdSense, a service that allows us to serve advertisements on our website. Google AdSense may use cookies to personalize the advertisements that you see.
      </p>
      <p>
        For more information on how Google uses cookies in advertising, please visit the <a href="https://policies.google.com/technologies/ads" target="_blank" rel="noopener noreferrer">Google Advertising Technologies Help page</a>.
      </p>
      <p>
